...
create table sam_design.categoria (
...
create table sam_design.repuesto (
  ...
  foreign key fk_repuesto_categoria (id_categoria) references categoria(id_categoria)
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;

create table sam_design.camisa (
  ...
  PRIMARY KEY (id_camisa),
   foreign key fk_camisa_categoria (id_categoria) references categoria(id_categoria))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;

CREATE TABLE sam_design.impermeable (
    id_impermeable INT NOT NULL AUTO_INCREMENT,
    id_categoria INT NOT NULL,
    descripcion VARCHAR(30),
    detalle VARCHAR(1600),
    talla VARCHAR(10),
    ...
    ruta_imagen VARCHAR(1024),
    activo BOOL,
    PRIMARY KEY (id_impermeable),
    foreign key fk_impermeable_categoria (id_categoria) references categoria(id_categoria))  
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4;

/*Se crea la tabla de usuarios llamada usuario... igual que la clase Usuario*/
CREATE TABLE sam_design.usuario (
...
create table sam_design.factura (
