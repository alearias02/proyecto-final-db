...
CREATE TABLE FIDE_SAMDESIGN.FIDE_ROL_TB (
    ...
    Modified_On  TIMESTAMP,
    CONSTRAINT FIDE_FK_ROL_STATUS FOREIGN KEY (Status_ID)
...
CREATE TABLE FIDE_SAMDESIGN.FIDE_USERS_TB (
    ...
    Modified_By VARCHAR2(50),
    Modified_On TIMESTAMP,
    CONSTRAINT FIDE_FK_USERS_STATUS FOREIGN KEY (Status_ID)
        REFERENCES FIDE_SAMDESIGN.FIDE_STATUS_TB(Status_ID),
    CONSTRAINT FIDE_FK_USERS_ROL FOREIGN KEY (Rol_ID)
...
CREATE TABLE FIDE_SAMDESIGN.FIDE_CATEGORY_TYPE_TB (
    ...
    Modified_By  VARCHAR2(50),
    Modified_On  TIMESTAMP,
    CONSTRAINT FIDE_FK_CATEGORY_STATUS FOREIGN KEY (Status_ID) 
        REFERENCES FIDE_SAMDESIGN.FIDE_STATUS_TB(Status_ID)
);
...
CREATE TABLE FIDE_SAMDESIGN.FIDE_VENDOR_TB (
    ...
    Modified_On        TIMESTAMP,
    Status_ID          NUMBER,
    CONSTRAINT FIDE_FK_VENDOR_STATUS FOREIGN KEY (Status_ID)
        REFERENCES FIDE_SAMDESIGN.FIDE_STATUS_TB(Status_ID)
);
