...
CREATE TABLE FIDE_SAMDESIGN.FIDE_USERS_TB (
    ...
    CONSTRAINT FIDE_FK_STATUS_ID FOREIGN KEY (Status_ID)
        REFERENCES FIDE_SAMDESIGN.FIDE_STATUS_TB(Status_ID),
    CONSTRAINT FIDE_FK_ROL_ID FOREIGN KEY (Rol_ID)
...
CREATE TABLE FIDE_SAMDESIGN.FIDE_ADDRESS_TB (
    ...
    CONSTRAINT FK_ADDRESS_STATE
        FOREIGN KEY (ID_State) REFERENCES FIDE_SAMDESIGN.FIDE_STATE_ADDRESS_TB(State_ID),
    CONSTRAINT FK_ADDRESS_CITY
        FOREIGN KEY (ID_City) REFERENCES FIDE_SAMDESIGN.FIDE_CITY_ADDRESS_TB(City_ID),
    CONSTRAINT FK_ADDRESS_COUNTRY
        FOREIGN KEY (ID_Country) REFERENCES FIDE_SAMDESIGN.FIDE_COUNTRIES_TB(Country_ID),
    CONSTRAINT FK_ADDRESS_STATUS
        FOREIGN KEY (Status_ID) REFERENCES FIDE_SAMDESIGN.FIDE_STATUS_TB(Status_ID),
    CONSTRAINT FK_ADDRESS_CUSTOMER
        FOREIGN KEY (ID_Customer) REFERENCES FIDE_SAMDESIGN.FIDE_CUSTOMER_TB(Customer_ID)
);
-- 12
