...
CREATE TABLE FIDE_SAMDESIGN.FIDE_ORDER_TB (
    Order_ID          VARCHAR2(100) CONSTRAINT FIDE_PK_ORDER_ID PRIMARY KEY,
    Customer_ID       NUMBER,
...
ALTER TABLE FIDE_SAMDESIGN.FIDE_ORDER_TB 
ADD address_id NUMBER;

ALTER TABLE FIDE_SAMDESIGN.FIDE_ORDER_TB 
ADD CONSTRAINT FIDE_FK_FIDE_ORDER_TB_ADDRESS_ID 
